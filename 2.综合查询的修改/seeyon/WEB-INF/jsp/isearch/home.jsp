...
<body scroll="no">
<div class="comp" comp="type:'breadcrumb',comptype:'location',code:'F01_listPending'" comptype="breadcrumb"></div>
        ...
        <TR class=page2-header-line><TD width="100%" height=38 class="page-list-border-LRD  " vAlign=top>
            <TABLE width="100%" height="100%" border=0 cellSpacing=0 cellPadding=0>
                ...
                <TR class=page2-header-line>
                    ...
                    <TD class=page2-header-bg><fmt:message key="common.portlet.name.perIsearch" bundle="${v3xMainI18N}"/></TD>
    ...
    <tr height="100">
        <td  width="100%" valign="top" height="60">
            <table width="100%" height="60" border="0" cellpadding="0" cellspacing="0" >
                <tr>
                    <td align="left" valign="top" style="padding: 5px 5px 0px 0px;">
                                        ...
                                        <td class="" align="center" style="padding: 5px">
                                            ...
                                            <form method="get" id="isearchCForm" name="isearchCForm" action="${detailURL}" target="dataIFrame" onsubmit="return dealOnSubmit(this)" style="margin: 0px">
                                                ...
                                                <table id="tab1" width="100%" height="100%" border="0" class="noWrap">
                                                    <tr>
                                                        <td width="12%" align="right" nowrap="nowrap"><fmt:message key="common.propertytype.label" bundle="${v3xCommonI18N}"/>:</td>
...
<%--                                                                &lt;%&ndash;                                                                    <option value="${v3x:toHTML(objValue)}" title="${v3x:toHTML(objName)}" docLibSelect='${appObj.needDocLibSelect}' hasPiged="${appObj.hasPigeonholed}"    > ${v3x:toHTML(objNameshowName)}</option>&ndash;%&gt;--%>
<%--                                                                <label><input type="checkbox" onclick="onselectAppType('${v3x:toHTML(objValue)}')" value="${v3x:toHTML(objValue)}" name="condition"/>${v3x:toHTML(objNameshowName)}</label>--%>
<%--                                                            </c:forEach>--%>
                                                            <%--                                                            </select>--%>
                                                            <%-- zhou:修改 --结束--%>
                                                        ...
                                                        <td width="38%" nowrap="nowrap"><input type="text" name="beginDate" id="beginDate"  style="width:90px;float:left;"  class="input-date" onclick="whenstart('${pageContext.request.contextPath}',this,575,140);" readonly >
                                                            <!--  <fmt:message key="common.to.label" bundle="${isearchI18N}"/> -->
                                                            ...
                                                            <td nowrap="nowrap"><input type="hidden" name="docLibId" id="docLibId" value="">
                                                                <c:if test="${v3x:hasPlugin('doc')}">
                                                                    ...
                                                                    <label for="auditOption5">
                                                                        <input type="radio" id="auditOption5" value="1" name="pigeonholedFlag0" onclick="onChangePigFlag(this)"><fmt:message key="common.archived.label" bundle="${isearchI18N}"/>
                                                                    </label>
                                                    ...
                                                    <tr>
                                                        <td align="center" colspan="4"><input type="submit" class="button-default_emphasize" name="b1" id="b1" onClick="isdefault()" value="<fmt:message key="common.button.condition.search.label" bundle="${isearchI18N}"/>"   class="button-default-2"></td>
                                                    </tr>
                                                </table>
                                            </form>
                                        </td>
            ...
            <div class="portal-layout-cell ">
                ...
                <div class="portal-layout-cell-right">
                    <div class="sectionSingleTitleLine border-tree" style="background:#fafafa;">
                        <span class="searchSectionTitle "><fmt:message key="common.query.result" bundle="${isearchI18N}"/>:</span>
                    </div>
                </div>
            </div>
        </td>
